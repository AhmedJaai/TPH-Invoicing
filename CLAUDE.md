...
| `src/lib/bank/lifecycle.ts` | طبقات الحركة: خام ← مُستنتَجة ← مقترَحة ← مُقَرَّة ← مُقيَّدة، وأعطابُها تُعرَض لا تُصحَّح |
...
| `src/lib/unit-conversion.ts` | لا جسر بين وزنٍ وحجم، والمجهول لا يُحوَّل |
...
`npm test` (١١٣٦ اختباراً · ٧٧ ملفاً) · `npm run typecheck` · `npm run lint`
