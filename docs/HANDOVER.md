> ⚠ **وثيقة مؤرّخة — لا تصف الحال اليوم.**
>
> كُتبت قبل المراحل الثلاث (٢٠٢٦-٠٩-٠٣)، وأكثر ما تسمّيه عيباً قد عولج بعدها:
> الخادم صار صاحب القرار، والمجهول لم يعد صفراً، والاستيراد صار منيعاً من
> التكرار، وواجهة الأرشفة صارت طبقة خدمات، والبنية صارت حول عمل المقهى لا
> حول جداول القاعدة.
>
> **مصدر الحقيقة عن المبنيّ فعلاً: [ARCHITECTURE.md](ARCHITECTURE.md).**
>
> تُبقى هذه هنا لأنّها سجلٌّ صادق لما كان — ومنها عُرف ما يجب أن يتغيّر.
