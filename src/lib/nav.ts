...
export const AREAS: readonly NavArea[] = [
  ...
  /*
    ...
    وأربعةُ ألسنةٍ لا أكثر: «الجرد الحالي» هو الفعل، و«سجلّ الجرد»
    هو التاريخ، و«الوصفات» و«الأصناف» هما ما يُضبَط مرّاتٍ في السنة.
    وما عداهما — التقريرُ والاتّجاهُ وتاريخُ الصنف والاستيرادُ
    والربطُ — يُفتَح من موضعه لا من شريطٍ يُقرأ كلّ يوم.
  */
  {
    href: "/inventory",
    label: "الجرد",
    ...
    owns: ["/inventory/counts", "/inventory/trend", "/inventory/import", "/inventory/mapping"],
    children: [
