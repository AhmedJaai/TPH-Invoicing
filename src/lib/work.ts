 ...
 * `countPendingWork()` يقول **صفراً**، والرئيسية تقول **تسعة**،
 ...
 * — ما تفتحه الصفحة هو ما يقوله العدّاد، حرفاً بحرف. و
 * `countPendingWork()` يبقى على حاله **مدخلاً** لبندٍ واحد من سبعةَ
 * عشر (حركاتٌ لم تُصنَّف)، لا عنواناً فوق التطبيق كلّه.
 *
