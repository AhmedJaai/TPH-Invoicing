...
export function syncRows<T>(
  ...
  */
  ...
  for (const item of incoming) {
    ...
    /*
      المتساهل لا يُستعمَل إلّا بدليلٍ على أنّهما عمليّة واحدة.

      وهو يُسقط الأرقام كلّها. فحوالتان في يومٍ واحد بمبلغٍ واحد لا
      يفرّقهما إلّا رقمُ عمليّةٍ في نصّهما:

          TRF ABC 123456
          TRF ABC 654321

      تتساويان فيه. ولو استُعمل بلا شرط لابتلعت الأولى الثانية:
      **حركةٌ حقيقيّة تختفي بلا شكوى** — وهو أسوأ من التكرار، لأنّ
      التكرار يُرى والنقص لا يُرى.

      فالشرط: أن يحمل أحدُ الطرفين مرجعَ عمليّة. حينئذٍ إمّا أن يكون
