      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {canEdit && !closed && (
          <ConfirmAction
            ...
            consequence="يخرج هذا التنبيه من «ما يحتاج انتباهك» ولا يُطالَب بالمال. استعمله حين تكون العمليّتان مستحقّتين فعلاً — فاتورتان بالمبلغ نفسه مثلاً. ويُكتب قرارك في سجلّ التدقيق باسمك، ويمكن فتحه ثانيةً."
