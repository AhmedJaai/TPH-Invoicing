  ...
  const tiles: HubTile[] = [
    ...
    },
    {
      /*
        ...
        ثمّ كانت تفتح قائمة الفواتير، وهي بالفاتورة لا بالمورّد: فمن دفع
        لمورّدٍ مقدَّماً يرى فواتيره «مستحقّة» وقد سدّدها. **والرقمُ الذي
        لا تفتح وجهتُه تفصيلَه يُفقد الثقة به.**
      */
